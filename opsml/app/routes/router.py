...
from opsml.app.routes import cards, data, files, healthcheck, homepage, models, settings, base, audit
...
api_router.include_router(base.router, tags=["base"], prefix="/opsml")
