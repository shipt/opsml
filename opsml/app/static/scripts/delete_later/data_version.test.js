...
test('test-buildDataVersionUI', () => {
  ...
  expect(document.getElementById('data-uri').href).toBe(`/opsml/data/download?uid=${fakeData["card"].uid}`);
  expect(document.getElementById('data-profile-uri').href).toBe(`/opsml/data/download/profile?uid=${fakeData["card"].uid}`);
