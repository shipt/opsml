<script lang="ts">
  ...
  export let registry;
  export let date;
  export let defaultCss = "block p-2 mb-2 bg-white rounded-2xl w-full border border-black shadow-[-6px_6px_0px_0px_black]"
...
<a class={ defaultCss } href="#">
  ...
  <div class="mr-1 ml-0.5 flex items-center overflow-hidden whitespace-nowrap text-sm leading-tight text-gray-400">
    <svg class="flex-none w-3 text-gray-400 mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    <svg class="flex-none w-3 text-gray-400 mr-0.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
